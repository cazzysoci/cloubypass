...
æ­¤è„šæœ¬é€‚ç”¨äºŽ CloudFlare ç›®æ ‡
 
ç”¨æ³•: node CLOUDFLARE.js [target] [time] [rps] [threads] [proxy]
ä¾‹å­: node CLOUDFLARE.js https://vire.cc 300 32 8 proxy.txt

This is made by @zashfarm (worst developer)
è¿™æ˜¯ç”±@zashfarmï¼ˆæœ€å·®çš„å¼€å‘äººå‘˜ï¼‰åˆ¶ä½œçš„
`); process.exit();}
 const headers = {};
...
// create headers / select headers (æ ‡é¢˜ç³»ç»Ÿ)
